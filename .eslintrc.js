module.exports = {
  ...
  rules: {
    ...
    'no-use-before-define': 0, //可以在未定义前使用
    camelcase: 0, //强制驼峰法命名
    ...
    'react/jsx-max-props-per-line': [1, { when: 'multiline' }], // 限制JSX中单行上的props的最大数量
    ...
    'no-return-assign': 0, //禁止在return下面使用赋值
